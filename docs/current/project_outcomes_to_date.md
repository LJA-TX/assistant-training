...
- Stage B completion: [docs/current/status/STAGE_B_COMPLETION_DETERMINATION.md](status/STAGE_B_COMPLETION_DETERMINATION.md)
- D1 closure and readiness: [docs/current/status/D1_CLOSURE_AND_D2_READINESS_ASSESSMENT.md](status/D1_CLOSURE_AND_D2_READINESS_ASSESSMENT.md)
...
- Supporting continuity records: [docs/continuity/D0_BLOCKER_REGISTER.md](../continuity/D0_BLOCKER_REGISTER.md), [docs/continuity/D0_TO_CURRENT_TREE_MECHANISM_ISOLATION_GOVERNANCE.md](../continuity/D0_TO_CURRENT_TREE_MECHANISM_ISOLATION_GOVERNANCE.md), [docs/continuity/D1_GOVERNANCE_FOUNDATION_PACKAGE.md](../continuity/D1_GOVERNANCE_FOUNDATION_PACKAGE.md)
