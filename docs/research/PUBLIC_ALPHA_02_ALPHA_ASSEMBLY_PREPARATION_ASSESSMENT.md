...
| `docs/current/framework_vs_history.md` | Enumerates excluded families (`docs/convergence/`, `docs/continuity/`, `docs/deprecated/`, `configs/`, `manifests/`, `reports/`, `data/`) as if they were public navigation surfaces. | Prune to the alpha boundary and reframe the history/current split around the accepted public package. |
