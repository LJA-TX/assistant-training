...
Construct disciplined runtime-assistant behavior through staged runtime instruct alignment and tool specialization.
...
Datasets exhibiting excessive conversational padding, assistant socialization, or wrapper-heavy behavior should be aggressively filtered or down-weighted.

Preference should be given to datasets demonstrating concise, execution-oriented assistant behavior over socially conversational behavior.
