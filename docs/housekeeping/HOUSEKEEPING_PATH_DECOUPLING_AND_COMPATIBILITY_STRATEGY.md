...
| Current-path references in doctrine or historical doctrine | `docs/appendix_a_operational_execution_contract_v3a.md`, `docs/deprecated/*.md`, `docs/evaluation_manifest_v1.md` | Some references are active guidance, others are frozen provenance | Medium |
...
| `docs/continuity/`, `docs/deprecated/`, bootstrap docs, dormant proposals | index coverage check; random-sample link check | missing index coverage or ambiguous archive placement | history remains discoverable without staying on primary path |
