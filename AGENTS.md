...
| `push_checkpoint` | authorized push operations | `docs/framework/process_infrastructure/checklists/push_readiness_checklist.md`; `docs/framework/process_infrastructure/checklists/git_ignore_verification_checklist.md` |
